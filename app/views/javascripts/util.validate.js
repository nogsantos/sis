...
(function($) {
	$.validator.addMethod("cpf", function(value, element, type) {
		...
		return (type == 'format' || (type == 'both' && !isCpfFormatted($(element).val()))) ?
				'<span style="color:red;font-weight: bold;margin-left: 10px;">Formato do CPF não é válido.</style>' : '<span style="color:red;font-weight: bold;margin-left: 10px;">Por favor digite um CPF válido!</style>';
	});
