...
session_start();
/**
 * Descrição: Relatório de Operadores.
...
<html>
    <head>
        <title>Relat&oacute;rio de Operadores</title>
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $(window).load(function(){
                    montaFuncoes('<?= $CODG_FORMULARIO ?>','<?= $NOME_FORMULARIO ?>','<?= $oOperador->getNumgOperador() ?>')
    ...
    <body bgcolor="#FFFFFF">
        <div class="conteiner" style="display: none">
            <form method="get" name="form" id="form" action="preloperadores.php">
                            ...
                            <table border="0" cellpadding="1" cellspacing="3" width="100%">
                                <tr>
                                    <td class="normal11b" colspan="2">
                                        Nome Operador:<br />
                                        <input type="text" name="nomeOperador" id="nomeOperador" size="47" maxlength="60" class="borda"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="normal11b">
                                        Grupo:<br />
                                        <select name="grupo" class="borda" id="grupo" style="width:128px">
                                            <?= montaCombo($oGrupo->consultarGrupos(), numg_grupo, nome_grupo, null, true); ?>
                                        </select>
                                    </td>
                                    <td class="normal11b">
                                    ...
                                    <td class="normal11b">
                                        <fieldset class="fieldInFormulario">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                   <input type="radio" name="status" id="status" value="ambos" checked /> Ambos <br />
                                                <input type="radio" name="status" id="status" value="ativos" /> Ativos <br />
                                                <input type="radio" name="status" id="status" value="bloq" /> Bloqueados
                                            </table>
                                        </fieldset>
                                    </td>
                                </tr>
