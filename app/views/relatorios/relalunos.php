...
<html>
    <head>
        <title>Relat&oacute;rio de Alunos</title>
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                /**
                 * Descrição: Autocomplete numero do aluno
                 **/
                $( "#numrAluno" ).autocomplete({
                    source: "completerelalunos.php?tipoBusca=numr",
                    minLength: 1,
                 ...
                 **/
                $( "#nomeAluno" ).autocomplete({
                    source: "completerelalunos.php?tipoBusca=nome",
                    minLength: 2,
                    select: function( event, ui ) {
                        $(this).val(ui.item.id);
                    }
    ...
    <body bgcolor="#FFFFFF">
        <div class="conteiner" style="display: none">
            <form method="get" name="form" id="form" action="prelalunos.php">
                                    ...
                                    <td class="normal11b" colspan="2">
                                        <fieldset class="fieldFormulario">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                   <td class="normal11b" width="35%">
                                                    N&uacute;mero do Aluno:<br />
                                                    <input type="text" name="numrAluno" id="numrAluno" size="25" maxlength="25" class="borda"/>
                                                </td>
                                                <td class="normal11b" width="35%">
                                                    Nome:<br />
                                                    <input type="text" name="nomeAluno" id="nomeAluno" size="40" maxlength="40" class="borda"/>
                                                </td>
                                                <td class="normal11b" width="30%">
                                                    Cpf:<br />
