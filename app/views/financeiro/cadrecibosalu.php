...
session_start();
/**
 * Descrição: Emissão de recibos - Aluno
...
if ($numgRecibo != "" || $numrRecibo!= "" ){
    ...
    if(Erro::isError()){
      ...
      if ($oRecibo->getNumgAluno() == "") {
          $info = "Não Existe Recibo de Aluno Cadastrado com o Número Informado!";
      }
    }
}
 ...
 * Obs: O 'A' passado como parametro significa que deverá listar somente os recibos do tipo ALUNOS.
 * Tipos Existentes: P - Professor, A - Aluno e V - Avulso.
 */
$vRecibos = $oRecibo->consultarRecibos("A");
if (Erro::isError()
...
//                    location.href = 'financeiro/<?= $CODG_FORMULARIO ?>.php';
//                })
                /**
                 * Descrição: relatório.
                 **/
                 var option = 0;
                $("#linkRelReciboAlunos").click(function(){
                    if(option==0){
                        $("#relReciboAlunos").show(999);
                        $("#iconlinkRelReciboAlunos").removeClass("ui-icon ui-icon-circle-arrow-s").addClass("ui-icon ui-icon-circle-arrow-n");
                        option = 1;
                    }else{
                        $("#relReciboAlunos").hide(999);
                        $("#iconlinkRelReciboAlunos").removeClass("ui-icon ui-icon-circle-arrow-n").addClass("ui-icon ui-icon-circle-arrow-s");
                        option = 0;
                    }
                });
                /**
                ...
                /**
                 * Descrição: Auto complete nome do aluno.
                 **/
                $("#alunoRec").autocomplete({
                    source: "completerecalunos.php",
                    minLength: 2,
                    select: function( event, ui ) {
                        $(this).val(ui.item.value);
                        $("#numgAluno").val(ui.item.id);
                    }
		});
           });
        </script>
    ...
    <body bgcolor="#FFFFFF">
        <div class="conteiner" style="display: none">
            <form method="post" name="form" id="form" action="../../controllers/financeiro/pcadrecibos.php">
                ...
                <div id="tabs">
                    <ul>
                    <li><a href="#dadosAlu">Dados Gerais do Recibo</a></li></ul>
                    <div id="dadosAlu">                       
                                        ...
                                        <fieldset class="fieldFormulario">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                   <td class="normal11b" width="16%" >
                                                    ...
                                                    <input type="text" name="numrRecibo" id="numrRecibo" size="10" class="borda" style="width:150px;text-align: center;" value="<?= $oRecibo->getNumrRecibo()!=""?$oRecibo->getNumrRecibo():$oRecibo->geraNumrRecibo() ?>"/>
                                                </td>
                                     ...
                                     <td class="normal11b" >
                                        <fieldset class="fieldFormulario">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                   <td class="normal11b">
                                                    Aluno <br />
                                                    <?$Aluno = $oRecibo->getNumgAluno()!=""?$oRecibo->getNumgAluno():$numgAluno;?>
                                                    <input type="text" name="recebido" id="alunoRec" class="borda" id="recebido" style="width:372px" value="<?=$oAluno->consultaNomeAlunosNumg($Aluno)?>" />
                                                    <input type="hidden" name="numgAluno" id="numgAluno" value="" />
                                                </td>
                                            </table>
                                        </fieldset>
                                    </td>
...
<!--                                                <button id="novo">Novo Recibo</button>-->
           ...
           <?if($vRecibos->getCount() > 0){?>
            <div id="linkRelReciboAlunos" class="ui-corner-all ui-widget-content titles-rel-forms" style="width:240px;cursor: pointer;">
                Rela&ccedil;&atilde;o de recibos emitidos
                <div id="iconlinkRelReciboAlunos" class="ui-icon ui-icon-circle-arrow-s" style="position: relative;float: right;right: 10px"></div>
            </div>
            <table id="relReciboAlunos" cellpadding="3" cellspacing="3" style="width:100%;display: none;">
                <thead>
                    <tr>
                        ...
                        <th class="ui-widget-header ui-corner-all" style="height: 30px;" align="center" width="20%">Devedor</th>
